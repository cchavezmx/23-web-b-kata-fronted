    ...
    <div className="flex w-screen h-[50vh] justify-center flex-col items-center">
      ...
      <div>
        <form className="flex flex-col gap-3" onSubmit={handledLoginSubmit}>
          <input name="user" className="input w-[300px] p-2 rounded-sm" placeholder="User" />
          <input name="password" className="input w-[300px] p-2 rounded-sm" placeholder="Password" />
